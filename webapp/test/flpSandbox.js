		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Asset Tag Physical Inventory",
									"targetURL": "#comseagateui5assettagpi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comseagateui5assettagpi-display": {
								"semanticObject": "comseagateui5assettagpi",
								"action": "display",
								"description": "Asset Tag Physical Inventory",
								"title": "Asset Tag Physical Inventory",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.seagate.ui5.assettagpi",
									"url": sap.ui.require.toUrl("com/seagate/ui5/assettagpi")
								}
							}
						}
					}
